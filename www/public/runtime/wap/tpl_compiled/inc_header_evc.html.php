...
<div class="header">
	...
	<div class="c-hd" style="background: linear-gradient(to right, #ff5c40 0%, #ff755b 30%,#ff127a 100%);">
        <section class="cut_city">
              <a id="header_back_btn" backurl='-1'><i class="iconfont" style="color: #fff;">&#xe60b;</i></a>
	    </section>
        <section class="logo_img" style="color:#fff;"><?php echo $this->_var['data']['page_title']; ?></section>
