...
<div class="wrap" >
	...
	<div class="content">
		...
		<form action="<?php
echo parse_url_tag("u:index|user#phmodifypassword|"."".""); 
?>" id="ph_password_box">
				...
				<ul class="input-list split-line-top split-line">
					<li>
		 				...
		 				<label class="com-input">
							<?php if ($this->_var['user_info']['mobile'] == ''): ?>
		 					<input type="tel" class="phone" id="mobile" name="mobile" placeholder="请输入手机号">
							<?php else: ?>
							<input class="phone" disabled="true" value="<?php echo $this->_var['user_info']['mobile']; ?>" style="background:none;" >
							<input type="hidden" name="mobile" id="mobile" value="<?php echo $this->_var['user_info']['mobile']; ?>" />
							<?php endif; ?>
		 				</label>
					...
					<li>
						...
						<label>
		 					<input class="btn_phone" type="Button"  id="sms_btn" unique="2" value="点击获取验证码" lesstime="<?php echo $this->_var['sms_lesstime']; ?>" />
		 				</label>
		 				</div>
		 			</li>
					<li>
						...
						<div class="input-box split-line">
						<label class="com-input">
                                                    <input  class="testing third" type="password" name="new_pwd"  placeholder="请输入4个字符或以上的新密码" >
						</label>
						</div>
					</li>
					<li>
						...
						<div class="input-box split-line">
						<label class="com-input">
							<input  class="testing third" type="password" name="cfm_new_pwd"  placeholder="请再次输入新密码">
						</label>
						</div>
					</li>
				</ul>
					<div class="login-btn-box">
					<input id="ph_password_box" type="submit" value="重置密码" class="login-btn ">
					</div>
