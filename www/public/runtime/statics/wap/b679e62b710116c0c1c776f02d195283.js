...
var uploadPreview = function(setting) {
    ...
    _self.getObjectURL = function(file) {
        ...
        return url; };
    _self.Bind = function() { document.getElementById(_self.Setting.UpBtn).onchange = function() {
            if (this.value) {
...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(2(){5 c=m J();m I({H:"j-i",G:"K-L",F:"O"});$("#N").u("w",2(){5 4=$("#j-i")[0];5 8=$("#8").M();6(!4.9[0]){$.7("头像未上传");h}6(!8){$.7("昵称不能为空");h}6(4.9[0].a==\'e/Q\'||4.9[0].a==\'e/E\'||4.9[0].a==\'e/D\'){5 f=0;C(4.9[0],{A:B,P:12,17:2(){},16:2(l){f=1;15(l)},14:2(){},19:2(d){6(f!=1){5 3={g:d.g,1c:d.g.1b};c=R.1a(3);5 b={};b.18=c;b.8=8;$.13({V:U,3:b,a:"T",S:"W",X:2(3){6(3.11==0){$.7(3.z)}v{$.10(3.z,2(){x.y.t="s://o.n.p/q/r.k"})}},Z:2(){$.7("服务器提交错误")}})}}})}v{$.7("上传的文件格式有误")}});$("#Y").u("w",2(){x.y.t="s://o.n.p/q/r.k"})});',62,75,'||function|data|me|var|if|showErr|user_name|files|type|query|upfile_data|results|image|is_err|base64|return|btn|file|html|err|new|aliduobaodao|www|com|appDownLoad|index|https|href|bind|else|click|window|location|info|width|1200|lrz|gif|jpeg|ImgShow|DivShow|UpBtn|uploadPreview|Array|item|add|val|change_info|fileimg|height|png|JSON|dataType|post|suce_url|url|json|success|skip_change|error|showSuccess|status|900|ajax|always|alert|fail|before|img_data|done|stringify|length|size'.split('|'),0,{}))
