...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(R).V(d(){$("J[b=\'H\']").G("U",d(){4 l=$.f($(6).i("h[b=\'l\']").g());4 v=/^[\\w\\I-\\E]+$/;4 p=$.f($(6).i("h[b=\'F\']").g());4 j=$.f($(6).i("h[b=\'j\']").g());1(j==0){4 n=$.f($(6).i("h[b=\'n\']").g());4 q=$.f($(6).i("h[b=\'q\']").g())}1(l==""){$.8("用户名不能为空");c 7}s 1(!v.t(l)){$.8("您输入的用户名不合法！");c 7}1(p){4 u=/^([a-e-m-9]+[k|\\k|\\.]?)*[a-e-m-9]+@([a-e-m-9]+[k|\\k|\\.]?)*[a-e-m-9]+\\.[a-e-S]{2,3}$/;1(!u.t(p)){$.8("请输入正确的邮箱地址");c 7}}1(j==0){1(n==""){$.8("请输入密码");c 7}1(n!=q){$.8("密码输入不匹配，请确认");c 7}}4 A=$(6).L();4 r=$(6).M("N");$.P({O:r,X:A,K:"Q",W:"T",D:d(5){1(5.C){$.B(5.y,d(){1(5.o)x.z=5.o})}s{$.8(5.y,d(){1(5.o)x.z=5.o})}}});c 7})});',60,60,'|if|||var|obj|this|false|showErr|||name|return|function|zA|trim|val|input|find|is_phone_register|_|user_name|Z0|user_pwd|jump|email|cfm_user_pwd|ajax_url|else|test|myreg|name_rul||location|info|href|query|showSuccess|status|success|u9fa5|user_email|bind|account_form|u4e00|form|type|serialize|attr|action|url|ajax|POST|document|Z|json|submit|ready|dataType|data'.split('|'),0,{}))
