...
eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[c.toString(a)]=k[c]||c.toString(a)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('4 f(g,2,3){h 1=i e();1.2=2;1.3=3;1.c="d";$.9("确定选择这个地址吗？",4(){$.b({a:j,0:1,w:"s",k:"u",v:4(0){7(0.r){5.6=$0.q}8 7(0.m){5.6=l}8{$.n(0.o)}}})});p t}',33,33,'data|query|consignee_id|order_item_id|function|location|href|if|else|showConfirm|url|ajax|act|uc_luck_confirm_address|Object|confirm_address|obj|var|new|main_url|type|next_url|status|showErr|info|return|jump|user_login_status|json|false|POST|success|dataType'.split('|'),0,{}))
