...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(R).Q(6(){$("P[d=\'S\']").F("T",6(){8 4=$("q[d=\'4\']").l();8 9=$("q[d=\'9\']").l();5($.v(9)==""||w(9)||x(9)<=0){$.f("请选择支付方式");j r}5($.v(4)==""||w(4)||x(9)<=0){$.f("请选择正确的充值金额");j r}8 4;$(".c").C(6(){4=I($(".b").l())});5(9==7){N.g.K="M://L.W.X/18/u/17.u?4 = "+4}8 y=$(e).1a();8 i=$(e).p("i");$.1b({t:i,16:y,10:"Z",Y:"o",11:6(3){5(3.z==1){5(3.s){8 o=\'{"t":"\'+3.a+\'&s=1","13":"1"}\';G.15(o)}h{g.k=3.a}}h 5(3.z==2){J{8 E=19(3[\'U\']);G.14(E)}12(A){$.f(A)}}h{5(3.B){$.f(3.B,6(){5(3.a){g.k=3.a}})}h{5(3.a){g.k=3.a}}}}});j r});$(".c").F("C",6(){$(".c").n("b");$(e).D("b");$("q.c").p(\'d\',\'H\');$(e).p(\'d\',\'4\')});$(".m").O(6(){$(".c").n("b");$(e).D(\'b\')});$(".m").V(6(){$(".m").n("b")})});',62,74,'|||obj|money|if|function||var|payment_id|jump|selected|select_num|name|this|showErr|location|else|action|return|href|val|select_num1|removeClass|json|attr|input|false|is_app|url|php|trim|isNaN|parseFloat|query|status|ex|info|click|addClass|str|bind|App|xxx|String|try|herf|www|http|window|focus|form|ready|document|do_charge|submit|sdk_code|blur|caizhi998|com|dataType|POST|type|success|catch|open_url_type|pay_sdk|open_type|data|shanpay|Public|pay_sdk_json|serialize|ajax'.split('|'),0,{}))
