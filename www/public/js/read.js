        ...
        this.initBox = function() {
            ...
            if (self.options.type == 'wee') {
                html =  '<div class="weedialog">' +
                    ...
                    '					<button class="ui-button dialog-cancel" rel="dialog-cancel">å–æ¶ˆ</button>' +
                    '					<button class="ui-button dialog-ok" rel="dialog-ok">ç¡®å®š</button>' +
                    '				</div>' +
                    '			</td>' +
...
//			if (trigger.length == 0) {
//				alert('è¯·è®¾ç½®ä½ç½®çš„ç›¸å¯¹å¤ºå®å¸ç´ ');
//				self.close();
//				return false;
//			}
//			var scrollWidth = 0;
