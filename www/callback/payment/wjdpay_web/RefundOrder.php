...
//require_once(APP_ROOT_PATH.'system/payment/wjdpay/common/ConfigUtil.php');//京东支付配置文件
require_once(APP_ROOT_PATH."system/payment/wjdpay/common/HttpUtils.php");
require_once(APP_ROOT_PATH."system/payment/wjdpay/common/XMLUtil.php");
