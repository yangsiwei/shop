 ...
 * Time: 15:53
 */
class duobaofModule extends MainBaseModule
{
    public function index()
    {
        ...
        init_app_page();
        //等级限制
        $consume_level = $GLOBALS['db']->getOne("select coron5 from ".DB_PREFIX."consume_level where id =1");
        ...
        $data = call_api_core("duobaof","index", $param);
//        print_r($data);die;
        ...
        $GLOBALS['tmpl']->display("duobaof.html");
    }
}
?>
