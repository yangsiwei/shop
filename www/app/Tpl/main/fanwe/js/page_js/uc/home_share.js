$(document).ready(function(){
	...
	$("#home-share-pin-box").init_pin({pin_col_init_height:[0],pin_col_init_width:0,width:292,hSpan:12,wSpan:10,isAnimate:false,speed:300});
	$(".pages").hide();
	$("#hd_step").val(1);
	$("#ajax_wait").val(0);
...
function load_pin_page()
{
	...
	query.act = "home_share";
	query.page = page;
	query.step = step;
	query.step_size = step_size;
	query.id = $("input[name='user_id']").val();
